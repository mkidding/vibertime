            ...
            <footer className="bg-gray-900 border-t-2 border-purple-500 px-6 py-4">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        <span onClick={handleDebugTrigger} className="text-xs text-gray-600 font-mono cursor-pointer select-none hover:text-purple-500 transition-colors">v0.2.16</span>
                    </div>
                </div>
            </footer >
        </div >
